...
// This proxy can be created by calling TiYandexMobileMetricaAndroid.createExample({message: "hello world"})
@Kroll.proxy(creatableInModule=TiYandexMobileMetricaAndroidModule.class)
